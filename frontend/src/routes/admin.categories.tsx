      ...
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Manage skill keywords and discoverability tags for this vertical.
          </p>
        </div>
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <span
                      className={`flex-1 text-left font-medium ${active ? "text-primary" : ""}`}
                    >
                      {c.name}
                    </span>
                    {active && (
            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Manage skill keywords and discoverability tags for this
                  vertical.
                </p>
              </div>
              <div className="flex gap-2">
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="h-9 w-48 rounded-full pl-9"
                  />
                </div>
            ...
            <div className="mt-5 flex flex-wrap gap-2">
              {tags.map((t, i) => (
                ...
                >
                  ...
                  <span
                    className={
                      t.active ? "text-primary/70" : "text-muted-foreground"
                    }
                  >
                    {t.count}
                  </span>
                  {t.active && (
                    <X className="h-3 w-3 cursor-pointer text-primary" />
                  )}
                </motion.span>
              ))}
            </div>
...
function StatTile({
  ...
  value: string;
  hint: string;
  tint: "primary" | "clay" | "sage";
}) {
  const map = {
    primary: "from-primary/10 to-sage/10",
    clay: "from-clay/10 to-gold/10",
    sage: "from-sage/15 to-primary/10",
  } as const;
  return (
