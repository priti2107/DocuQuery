...
const features = [
  {
    ...
    desc: "Our AI understands the semantic structure of academic papers, not just the keywords.",
  },
  {
    icon: Briefcase,
    title: "Career Targets",
    desc: "Match your research findings with specific job requirements and skill sets.",
  },
  {
    icon: FileText,
    title: "Instant Digests",
    desc: "Get executive summaries of 50-page reports in a matter of seconds.",
  },
  {
    icon: Database,
    title: "Data Extraction",
    desc: "Automatically pull tables and charts into structured datasets for analysis.",
  },
];
...
const trending = [
  {
    tag: "FINANCE",
    title: "Q3 Market Volatility Analysis",
    meta: "4.2k Queries today",
    gradient: "from-clay/50 to-gold/40",
  },
  {
    tag: "BIOTECH",
    title: "mRNA Delivery Papers 2024",
    meta: "1.8k Queries today",
    gradient: "from-primary/60 to-sage/50",
  },
];
      ...
      <header className="sticky top-0 z-30 border-b border-border bg-background/70 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-7xl items-center gap-8 px-6">
          ...
          <nav className="hidden gap-6 text-sm text-muted-foreground md:flex">
            ...
            <Link to="/ai-query" className="hover:text-foreground">
              AI Query
            </Link>
          ...
          <div className="ml-auto flex items-center gap-4">
            <div className="relative hidden md:block">
              ...
              <Input
                ...
                className="h-9 w-56 rounded-full bg-muted/50 pl-9"
              />
            </div>
            <Link
              to="/login"
            ...
            <Button
              asChild
              className="rounded-full px-5 bg-primary hover:bg-primary/90 text-primary-foreground cursor-pointer"
            >
        ...
        <div className="relative mx-auto max-w-5xl px-6 pb-12 pt-20 text-center">
          ...
          >
            ...
            <p className="mx-auto mt-6 max-w-2xl text-base text-muted-foreground md:text-lg">
              Transform complex PDFs, research papers, and case studies into
              actionable insights. DocuQuery uses advanced LLMs to help you
              master any subject in seconds.
            </p>
            <div className="mt-8 flex flex-wrap justify-center gap-3">
              <Button asChild size="lg" className="rounded-full px-6">
                <Link to="/documents">
                  Upload a Document <ArrowRight className="ml-1 h-4 w-4" />
                </Link>
              </Button>
              <Button
                asChild
        ...
        <div className="grid gap-8 md:grid-cols-3">
          <div>
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              See what other researchers and candidates are analyzing this week.
          ...
          {trending.map((t) => (
            ...
            >
              ...
              <div className="relative flex h-full flex-col justify-end">
                <span className="inline-flex w-fit rounded-full bg-primary px-2.5 py-1 text-[10px] font-semibold tracking-wider text-primary-foreground">
                  {t.tag}
                </span>
                <h3 className="mt-2 font-serif text-xl font-semibold text-background drop-shadow">
                  {t.title}
                </h3>
        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary to-primary/80 p-12 text-center text-primary-foreground shadow-lift">
          ...
          <div className="relative">
            ...
            <p className="mx-auto mt-3 max-w-xl text-sm text-primary-foreground/80">
              Join 50,000+ students and professionals who are using AI to
              accelerate their careers and academic excellence.
            </p>
            <div className="mt-6 flex flex-wrap justify-center gap-3">
              <Button
                asChild
                variant="secondary"
                className="rounded-full px-6 bg-white hover:bg-slate-100 text-slate-900 cursor-pointer"
              >
      ...
      <footer className="border-t border-border bg-card">
        <div className="mx-auto grid max-w-7xl gap-8 px-6 py-12 md:grid-cols-4">
          ...
          {[
            {
              h: "Product",
              items: ["Pricing", "Features", "Integrations", "API"],
            },
