...
export const Route = createFileRoute("/_user/analytics")({
  component: Analytics,
});
...
const topDocs = [
  ...
  {
    rank: "02",
    name: "Neural Networks 101.docx",
    meta: "312 total interactions",
  },
  {
    rank: "03",
    name: "User Interview Summary.txt",
    meta: "128 total interactions",
  },
  {
    rank: "04",
    name: "Product Roadmap 2024.pdf",
    meta: "94 total interactions",
  },
      ...
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Real-time insights across your intellectual repository.
          </p>
        </div>
      ...
      <div className="surface-card flex flex-wrap items-center gap-5 bg-gradient-to-br from-primary/10 to-sage/10 p-6">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-muted-foreground">
            Your query volume peaked on Thursday. Consider automating repetitive
            questions through our Knowledge Graph feature.
          </p>
        </div>
        <Button variant="outline" className="rounded-full">
          Explore Features
