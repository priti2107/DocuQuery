      ...
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Manage reported content and user behavioral issues across the
            platform.
          </p>
        </div>
          ...
          <tbody>
            {reports.map((r, i) => (
              ...
              >
                ...
                <td className="px-5 py-4">
                  <span
                    className={`rounded-full px-2.5 py-0.5 text-xs font-medium ${reasonTint[r.reason]}`}
                  >
                    {r.reason}
                  </span>
                </td>
                ...
                <td className="px-5 py-4 text-right text-xs">
                  ...
                  <button className="font-medium text-destructive hover:underline">
                    Remove
                  </button>
      ...
      <div className="grid gap-5 lg:grid-cols-2">
        ...
        <div className="surface-card p-6">
          ...
          <ul className="mt-3 space-y-3 text-sm">
            <li>
              <div className="font-medium">System Auto-Moderation</div>
              <div className="text-xs text-muted-foreground">
                Flagged user @troll_bot for suspicious login patterns.{" "}
                <span>2 mins ago</span>
              </div>
            </li>
            <li>
              <div className="font-medium">Resolution Log</div>
              <div className="text-xs text-muted-foreground">
                Admin Alex Rivera removed "Fake Scholarship Ad" report. 14 mins
                ago
              </div>
            </li>
            <li>
              ...
              <div className="text-xs text-muted-foreground">
                3 identical reports for news item "Crypto News". 45 mins ago
              </div>
            </li>
          </ul>
        </div>
